...
#
#     PHX_SERVER=true bin/lectures_on_tap start
#
# Alternatively, you can use `mix phx.gen.release` to generate a `bin/server`
# script that automatically sets the env var above.
if System.get_env("PHX_SERVER") do
  config :lectures_on_tap, LecturesOnTapWeb.Endpoint, server: true
end
...
if config_env() == :prod do
  ...
  config :lectures_on_tap, :dns_cluster_query, System.get_env("DNS_CLUSTER_QUERY")
  ...
  #
  #     config :lectures_on_tap, LecturesOnTap.Mailer,
